/**
 * This program creates different types of data structures then analyzes how 
 * long it takes to do opperations such as add, search, sort, and delete. 
 * It then takes the total times.
 * 
 * @author Cohl Dorsey
 */
...
public class NumberCruncher
{
	...
	public static void main(String[] args)
	{
		...
		//Searches data
		System.out.println("------------------------");
		int[] targets = generate(DATA_SIZE/20); //original number in denominator of the devide was 10.
		for (int y = 0; y < dataTypes.length; y++)
		{
			int hits = 0;
			long startTime = System.nanoTime();
